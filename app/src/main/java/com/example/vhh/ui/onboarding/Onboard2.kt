...
import com.example.vhh.ui.destinations.Onboard3Destination
...
@Destination
@Composable
fun Onboard2 (navigator: DestinationsNavigator) {
    Box(
        modifier = Modifier
            .fillMaxSize()
        ...
        Image(
            painter = painterResource(id = R.drawable.nurse2), contentDescription = "",
        ...
        Column(
            ...
            Row (
                ...
                Text(
                    text = " &", fontSize = 25.sp,
                    fontWeight = FontWeight.Bold, color = Color.White.copy(0.3f),
                )}
                Text(
            ...
            Image(painter = painterResource(id = R.drawable.next), contentDescription = "",
                modifier = Modifier.clickable {  navigator.navigate(Onboard3Destination)}
