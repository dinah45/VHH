...
@Destination
@Composable
fun Onboard4 (navigator: DestinationsNavigator) {
    Box(
        modifier = Modifier
            .fillMaxSize()
        ...
        Image(
            painter = painterResource(id = R.drawable.nurse4), contentDescription = "",
        ...
        Column(
            ...
            Image(painter = painterResource(id = R.drawable.next), contentDescription = "",
                modifier = Modifier.clickable { navigator.navigate(StartDestination) }
